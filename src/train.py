...
parser.add_argument("--max_len", default=64, type=float, help="maximum sequence length")
parser.add_argument("--batch_size", default=32, type=int, help="batch size")
parser.add_argument("--epochs", default=4, type=float, help="number of epochs")
parser.add_argument("--seed_val", default=12, type=float, help="Seed value")
...
'''
print("seeker post")
print(df.response_post[0])
print("response post")
print(df.seeker_post[0])
...
if args.do_validation:
	...
	print("val_rationales_trimmed", val_rationales_trimmed)
